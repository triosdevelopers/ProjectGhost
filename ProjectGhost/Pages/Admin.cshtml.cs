...
namespace ProjectGhost.Pages
{
    public class AdminModel : PageModel
    {
        ...
        {
            //Program.Connections.Send_cmd("im", 5);
        }
        public void OnPostStartRecording()
        {
            //Program.Connections.Send_cmd("ca", 1);
        }
        public void OnPostStopRecording()
        {
            //Program.Connections.Send_cmd("ca", 0);
        }
